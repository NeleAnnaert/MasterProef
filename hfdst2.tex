...
\end{description}
Uit (3.10) berekenen we de hoek E door elke keer voor horzontaal een lengte in te vullen. Eens de hoek berekend is kunnen we gemakkelijk de hoogte berekenen via (3.11). Een overzicht van de berekende waarden, ziet u in tabel \ref{refTabCNRBB}.
\begin{table}[h]
	\begin{tabular}{|c|c|c|}
		\hline
...
\end{figure} 
 ...
 \label{mRefDNN}
 Deze klasse is afgeleid van de eerste besproken Detect \ref{mRefDet} klasse. Deze klasse is gemaakt om te werken met live beelden en zonder normalisatie. Deze klasse heeft \'{ee}n methode. Namelijk createMask.
